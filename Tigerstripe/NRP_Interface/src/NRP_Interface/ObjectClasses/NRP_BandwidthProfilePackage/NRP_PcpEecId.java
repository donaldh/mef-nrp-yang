...
/**
 * This is a choice for Vlan tag (S tag or C tag) PCP based EecId.
 *
 ...
 * 
 */
public abstract class NRP_PcpEecId
 {



    /**
     * Which vlan tag pcp to be used for ceec identier, S tag or C tag. S tag is not valid for EvcEndPoint. 
     * @tigerstripe.field 
     *  isOptional = "false"
     *  isReadOnly = "false"
     *  isOrdered = "false"
    ...
    /**
     * List of PCP values that map to the eec name.
     * @tigerstripe.field 
     *  isOptional = "false"
     *  isReadOnly = "false"
     *  isOrdered = "false"
     ...
     * 
     */
	public NRP_Interface.TypeDefinitions.NRP_Types.NRP_NaturalNumber[] nrp_pcpValue;


    /**
     * Egress Equivelance Class name.
     * @tigerstripe.field 
     *  isOptional = "false"
     *  isReadOnly = "false"
     *  isOrdered = "false"
     ...
     * 
     */
	public java.lang.String nrp_eecName;
