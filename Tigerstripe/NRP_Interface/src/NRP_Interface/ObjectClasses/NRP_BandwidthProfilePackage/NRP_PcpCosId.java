...
/**
 * This is a choice for Vlan tag PCP based CosId.
 *
 ...
 * 
 */
public abstract class NRP_PcpCosId
 {



    /**
     * Which vlan tag pcp to be used for cos identier, S tag or C tag. S tag is not valid for EvcEndPoint. 
     * @tigerstripe.field 
     *  isOptional = "false"
     *  isReadOnly = "false"
     *  isOrdered = "false"
    ...
    /**
     * List of PCP values that map to the cos name.
     * @tigerstripe.field 
     *  isOptional = "false"
     *  isReadOnly = "false"
     *  isOrdered = "false"
