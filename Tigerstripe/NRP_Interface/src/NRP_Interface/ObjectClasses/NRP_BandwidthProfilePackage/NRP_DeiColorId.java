...
/**
 * This is for the Color Identifier that maps the vlan tag (S tag or C tag) DEI value to Color.
 *
 ...
 * 
 */
public abstract class NRP_DeiColorId
 {



    /**
     * Which vlan tag pcp to be used for color identier, S tag or C tag. S-tag is not valid for EvcEndPoint. 
     * @tigerstripe.field 
     *  isOptional = "false"
     *  isReadOnly = "false"
     *  isOrdered = "false"
     ...
     * 
     */
	public NRP_Interface.TypeDefinitions.NRP_Types.NRP_NaturalNumber[] nrp_deiValue;
