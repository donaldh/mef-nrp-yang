...
/**
 * Envelope is a bandwidth profile parameter which consists of an envelope ID and an envelope coupling flag (0) which controls conversion of unused Green tokens into Yellow tokens in the bandwidth profile algorithm. 
 *
 ...
 * 
 */
public abstract class NRP_Envelope
 {
     ...
     * 
     */
	public java.lang.String nrp_envelopeId;


    /**
     * Coupling flag for index zero. 0 for NO and 1 for YES (overflow Green tokens can be used as Yellow tokens)
     * @tigerstripe.field 
     *  isOptional = "false"
     *  isReadOnly = "false"
     *  isOrdered = "false"
     ...
     * 
     */
	public NRP_Interface.TypeDefinitions.NRP_Types.NRP_NaturalNumber nrp_couplingFlagForIndexZero;
