...
/**
 * Form U (U for UNI) is a list of one or more CE-VLAN ID values. A Service Frame is mapped to the OVC End Point if the CE-VLAN ID value of the Service Frame is in the list.
 *
 ...
 * 
 */
public abstract class NRP_EndPointMapFormU
 {
     ...
     * 
     */
	public NRP_Interface.TypeDefinitions.NRP_Types.NRP_VlanId[] nrp_cVid;
