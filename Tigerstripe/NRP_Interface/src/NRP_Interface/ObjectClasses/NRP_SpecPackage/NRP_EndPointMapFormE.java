...
/**
 * Form E (E for ENNI) consists of a list of one or more S-VLAN ID values. An S-Tagged ENNI Frame whose S-VLAN ID value matches an entry in the list maps to the OVC End Point.
 *
 ...
 * 
 */
public abstract class NRP_EndPointMapFormE
 {
