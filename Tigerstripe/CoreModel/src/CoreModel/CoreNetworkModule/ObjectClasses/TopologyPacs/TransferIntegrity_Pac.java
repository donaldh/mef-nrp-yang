...
Applies to TDM systems as the errored signal will be propagated and not packet as errored packets will be discarded.
     ...
     *     unit = ""
     *     support = "CONDITIONAL"
     *     condition = "Present if errorCharacteristics information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
...
Applies to packet systems and not TDM (as for TDM errored signals are propagated unless grossly errored and overflow/underflow turns into timing slips).
     ...
     *     unit = ""
     *     support = "CONDITIONAL"
     *     condition = "Present if lossCharacteristics information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
...
It can also apply to TDM where several frames may be received twice due to switching in a system with a large differential propagation delay.
     ...
     *     unit = ""
     *     support = "CONDITIONAL"
     *     condition = "Present if repeatCharacteristics information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
...
Does not apply to TDM as the TDM protocols maintain strict order.
     ...
     *     unit = ""
     *     support = "CONDITIONAL"
     *     condition = "Present if deliveryOrderCharacteristics information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
...
"
     ...
     *     unit = ""
     *     support = "CONDITIONAL"
     *     condition = "Present if serverIntegrityProcessCharacteristics information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
