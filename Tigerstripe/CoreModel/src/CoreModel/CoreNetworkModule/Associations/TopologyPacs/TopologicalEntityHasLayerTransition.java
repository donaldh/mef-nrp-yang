 ...
 * 
 */
public abstract class TopologicalEntityHasLayerTransition
 {
 ...
 *     unit = ""
 *     support = "CONDITIONAL"
 *     condition = "Present if layer transition information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
 ...
 * 
	 */	
	public CoreModel.CoreNetworkModule.ObjectClasses.TopologyPacs.LayerProtocolTransition_Pac _layerTransition_Pac = null;
