 ...
 * 
 */
public abstract class TopologicalEntityHasValidation
 {
 ...
 *     unit = ""
 *     support = "OPTIONAL"
 *     condition = "Present if validation information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
 ...
 * 
	 */	
	public CoreModel.CoreNetworkModule.ObjectClasses.TopologyPacs.Validation_Pac _validation_Pac = null;
