 ...
 * 
 */
public abstract class TopologicalEntityHasIntegrityCharacteristics
 {
 ...
 *     unit = ""
 *     support = "OPTIONAL"
 *     condition = "Present if transfer integrity information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
 ...
 * 
	 */	
	public CoreModel.CoreNetworkModule.ObjectClasses.TopologyPacs.TransferIntegrity_Pac _transferIntegrity_Pac = null;
