 ...
 * 
 */
public abstract class TopologicalEntityHasCostCharacteristics
 {
 ...
 *     unit = ""
 *     support = "CONDITIONAL"
 *     condition = "Present if cost information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
 ...
 * 
	 */	
	public CoreModel.CoreNetworkModule.ObjectClasses.TopologyPacs.TransferCost_Pac _transferCost_Pac = null;
