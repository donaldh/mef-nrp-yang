 ...
 * 
 */
public abstract class TopologicalEntityHasCapacityCharacteristics
 {
 ...
 *     unit = ""
 *     support = "CONDITIONAL"
 *     condition = "Present if transfer capacity information is relevant to usage and statement can be made that applies equally to all flows that can be supported by the TopologicalEntity.
 ...
 * 
	 */	
	public CoreModel.CoreNetworkModule.ObjectClasses.TopologyPacs.TransferCapacity_Pac _transferCapacity_Pac = null;
